				...
				<div class="column-12" style="height: 98vh;">
					...
					<div class="update">
						<form action="update_post.php" method="post" enctype='multipart/form-data'>
							...
							<input type="text" name="title" placeholder="title here..." value="<?php echo $post['title'] ?>"><br><br>
							...
							<img id="title_photo_preview" style="max-width:400px;max-height:400px" src="<?php echo $post['title_photo'] ?>">
							<input type="hidden" name="title_photo_old" value="<?php echo $post['title_photo'] ?>">
							<textarea name="content" placeholder="Content here..." ><?php echo $post['content'] ?></textarea><br><br>
							<button type="submit" name="update_post">Sửa bài</button>
						</form>
					</div>
				</div>
			</div>
