...
require "../conn.php";
$query_posts = "select id, title, title_photo, content, created_date, isDeleted, username, email, isClosed from posts join accounts on account_id = id_bin limit 20 offset 0";
...
foreach ($posts as $post) {
	...
	echo "<td style='word-break:break-all;display:inline-block;width:100%;min-width:68px;height:100%;max-height:90px'>".$post["title"]."</td>";
	...
	echo "<td style='word-break:break-all;display:inline-block;width:100%;min-width:68px;height:100%;max-height:90px'>".$post["content"]."</td>";
	echo "<td>".$post["created_date"]."</td>";
